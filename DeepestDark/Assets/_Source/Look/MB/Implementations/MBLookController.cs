...
namespace LookSystem.Implementations.MB.Implementations
{
    public class MBLookController : AMBLookController
    {
        ...
        public override void LookAt(Vector2 mouseScreenPosition)
        {
