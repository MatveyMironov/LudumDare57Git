...
namespace FlashlightSystem.Implementations.MB.Implementations
{
    public class MBFlashlight : AMBFlashlight
    {
        [Header("References")]
        ...
        public override int CurrentConfigurationIndex { get => _currentConfigurationIndex; }
        ...
        public override void SwitchToNextConfiguration()
        {
        ...
        public override void SwitchToPreviousConfiguration()
        {
        ...
        public override void SwitchToConfiguration(int index)
        {
            ...
            _currentConfigurationIndex = index;
        }
